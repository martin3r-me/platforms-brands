        ...
        <x-ui-page-actionbar :breadcrumbs="[
            ...
            <x-slot name="left">
                @can('update', $typographyBoard)
                    <x-ui-button variant="ghost" size="sm" x-data @click="$dispatch('open-modal-typography-board-settings', { typographyBoardId: {{ $typographyBoard->id }} })">
            ...
            @can('update', $typographyBoard)
                <x-ui-button variant="primary" size="sm" x-data @click="$dispatch('open-modal-typography-entry', { typographyBoardId: {{ $typographyBoard->id }} })">
