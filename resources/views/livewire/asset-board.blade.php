        ...
        <x-ui-page-actionbar :breadcrumbs="[
            ...
            <x-slot name="left">
                @can('update', $assetBoard)
                    <x-ui-button variant="ghost" size="sm" x-data @click="$dispatch('open-modal-asset-board-settings', { assetBoardId: {{ $assetBoard->id }} })">
            ...
            @can('update', $assetBoard)
                <x-ui-button variant="primary" size="sm" x-data @click="$dispatch('open-modal-asset', { assetBoardId: {{ $assetBoard->id }} })">
