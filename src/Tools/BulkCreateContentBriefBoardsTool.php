            ...
            'properties' => [
                ...
                'defaults' => [
                    ...
                    'properties' => [
                        ...
                        'content_type' => ['type' => 'string', 'description' => 'Werte per Lookup-Tabelle (brands.lookup_values.GET name="content_type").'],
                        'search_intent' => ['type' => 'string', 'description' => 'Werte per Lookup-Tabelle (brands.lookup_values.GET name="search_intent").'],
                        'status' => ['type' => 'string', 'description' => 'Werte per Lookup-Tabelle (brands.lookup_values.GET name="content_brief_status").'],
                ...
                'content_brief_boards' => [
                    ...
                    'items' => [
                        ...
                        'properties' => [
                            ...
                            'content_type' => ['type' => 'string', 'description' => 'Werte per Lookup-Tabelle.'],
                            'search_intent' => ['type' => 'string', 'description' => 'Werte per Lookup-Tabelle.'],
                            'status' => ['type' => 'string', 'description' => 'Werte per Lookup-Tabelle.'],
                            'target_url' => ['type' => 'string', 'description' => 'Qualifizierte Ziel-URL.'],
