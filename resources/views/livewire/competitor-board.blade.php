        ...
        <x-ui-page-actionbar :breadcrumbs="[
            ...
            <x-slot name="left">
                @can('update', $competitorBoard)
                    <x-ui-button variant="ghost" size="sm" x-data @click="$dispatch('open-modal-competitor-board-settings', { competitorBoardId: {{ $competitorBoard->id }} })">
            ...
            @can('update', $competitorBoard)
                <x-ui-button variant="primary" size="sm" x-data @click="$dispatch('open-modal-competitor', { competitorBoardId: {{ $competitorBoard->id }} })">
                    @svg('heroicon-o-plus', 'w-4 h-4')
                    <span>Wettbewerber hinzufügen</span>
                </x-ui-button>
            @endcan
        </x-ui-page-actionbar>
    </x-slot>
        ...
        <div>
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-[var(--ui-muted)]">Wettbewerber-Profile mit Stärken und Schwächen</p>
                    </div>
                </div>
                @can('update', $competitorBoard)
                    <x-ui-button
                                    ...
                                    @can('update', $competitorBoard)
                                        <div class="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            <button
                                                ...
                                                wire:confirm="Wettbewerber wirklich löschen?"
            ...
            @else
                <div class="text-center py-16 border-2 border-dashed border-[var(--ui-border)]/40 rounded-xl bg-[var(--ui-muted-5)]">
                    ...
                    <p class="text-xs text-[var(--ui-muted)] mb-4">Füge Wettbewerber hinzu, um die Marktpositionierung zu analysieren</p>
                    @can('update', $competitorBoard)
                        <x-ui-button
                            variant="primary"
                            size="sm"
            ...
            <div>
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-[var(--ui-muted)]">{{ $competitorBoard->axis_x_label }} vs. {{ $competitorBoard->axis_y_label }} – Markenpositionierung im Wettbewerbsumfeld</p>
                    </div>
                </div>
        ...
        @elseif($competitors->count() > 0)
            <div>
                ...
                <div class="text-center py-12 border-2 border-dashed border-[var(--ui-border)]/40 rounded-xl bg-[var(--ui-muted-5)]">
                    ...
                    <p class="text-xs text-[var(--ui-muted)]">Markiere einen Wettbewerber als „Eigene Marke" und füge Differenzierungsmerkmale hinzu.</p>
                </div>
            </div>
        @endif
    </x-ui-page-container>
