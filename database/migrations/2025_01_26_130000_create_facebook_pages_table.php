    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable($tableName)) {
            Schema::create($tableName, function (Blueprint $table) {
                ...
                $table->index(['user_id'], 'fp_user_id_idx');
                $table->index(['external_id'], 'fp_external_id_idx');
                $table->index(['expires_at'], 'fp_expires_at_idx');
                $table->unique(['external_id', 'user_id'], 'fp_external_user_uniq');
            });
        } else {
            ...
            $indexes = [
                [['user_id'], 'fp_user_id_idx'],
                [['external_id'], 'fp_external_id_idx'],
                [['expires_at'], 'fp_expires_at_idx'],
            ];
            ...
            $uniqueExists = DB::select(
                ...
                [$databaseName, $tableName, 'fp_external_user_uniq']
            );
