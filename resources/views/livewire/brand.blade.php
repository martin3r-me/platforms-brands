<x-ui-page>
    ...
    <x-ui-page-container spacing="space-y-6">
        ...
        <div>
            ...
            @php
                $hasAnyBoards = $ciBoards->count() > 0 || $contentBoards->count() > 0 || $socialBoards->count() > 0 || $kanbanBoards->count() > 0 || $multiContentBoards->count() > 0 || $typographyBoards->count() > 0 || $logoBoards->count() > 0 || $toneOfVoiceBoards->count() > 0 || $personaBoards->count() > 0 || $competitorBoards->count() > 0 || $guidelineBoards->count() > 0 || $moodboardBoards->count() > 0 || $facebookPages->count() > 0 || $instagramAccounts->count() > 0;
            @endphp
