    ...
    <x-slot name="header">
        <div class="flex items-center justify-between w-full">
            <div class="flex items-center gap-3">
                ...
                <span class="text-xs text-[color:var(--nx-faint)] bg-[color:var(--nx-hover)] px-2 py-1 rounded-full">PERSONA</span>
            </div>
        </div>
    </x-slot>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        />
                        <div>
                            <label class="block text-sm font-medium text-[color:var(--nx-text)] mb-1.5">Geschlecht</label>
                            <select
                    ...
                    <div>
                        <label class="block text-sm font-medium text-[color:var(--nx-text)] mb-1.5">Biografie / Kurzbeschreibung</label>
                        <textarea
            ...
            <div>
                <div class="flex items-center justify-between mb-4">
                    ...
                    <x-nx-button variant="ghost" size="sm" type="button" wire:click="addPainPoint">
                    ...
                    <div class="space-y-2">
                        @foreach($personaPainPoints as $index => $point)
                            <div class="flex items-center gap-2">
                                ...
                                />
                                <button type="button" wire:click="removePainPoint({{ $index }})" class="p-2 text-[color:var(--nx-faint)] hover:text-red-500 transition-colors flex-shrink-0">
            ...
            <div>
                <div class="flex items-center justify-between mb-4">
                    ...
                    <x-nx-button variant="ghost" size="sm" type="button" wire:click="addGoal">
                        <div class="flex items-center gap-2">
                            @svg('heroicon-o-plus', 'w-4 h-4')
                            Hinzufügen
                        </div>
                        ...
                        @foreach($personaGoals as $index => $goal)
                            <div class="flex items-center gap-2">
                                <x-nx-input-text
                                    ...
                                    placeholder="Ziel..."
                                />
                                <button type="button" wire:click="removeGoal({{ $index }})" class="p-2 text-[color:var(--nx-faint)] hover:text-red-500 transition-colors flex-shrink-0">
                                    @svg('heroicon-o-x-mark', 'w-4 h-4')
                                </button>
                            </div>
                        @endforeach
            ...
            <div>
                <div class="flex items-center justify-between mb-4">
                    ...
                    <x-nx-button variant="ghost" size="sm" type="button" wire:click="addQuote">
                        <div class="flex items-center gap-2">
                            @svg('heroicon-o-plus', 'w-4 h-4')
                            Hinzufügen
                        </div>
                        ...
                        @foreach($personaQuotes as $index => $quote)
                            <div class="flex items-center gap-2">
                                <x-nx-input-text
                                    ...
                                    placeholder="Zitat..."
                                />
                                <button type="button" wire:click="removeQuote({{ $index }})" class="p-2 text-[color:var(--nx-faint)] hover:text-red-500 transition-colors flex-shrink-0">
                                    @svg('heroicon-o-x-mark', 'w-4 h-4')
                                </button>
                            </div>
                        @endforeach
            ...
            <div>
                <div class="flex items-center justify-between mb-4">
                    ...
                    <x-nx-button variant="ghost" size="sm" type="button" wire:click="addBehavior">
                        <div class="flex items-center gap-2">
                            @svg('heroicon-o-plus', 'w-4 h-4')
                            Hinzufügen
                        </div>
                    ...
                    <div class="space-y-2">
                        @foreach($personaBehaviors as $index => $behavior)
                            <div class="flex items-center gap-2">
                                ...
                                />
                                <button type="button" wire:click="removeBehavior({{ $index }})" class="p-2 text-[color:var(--nx-faint)] hover:text-red-500 transition-colors flex-shrink-0">
                                    @svg('heroicon-o-x-mark', 'w-4 h-4')
                                </button>
                            </div>
                        @endforeach
            ...
            <div>
                <div class="flex items-center justify-between mb-4">
                    ...
                    <x-nx-button variant="ghost" size="sm" type="button" wire:click="addChannel">
                        <div class="flex items-center gap-2">
                            @svg('heroicon-o-plus', 'w-4 h-4')
                            Hinzufügen
                        </div>
                    ...
                    <div class="space-y-2">
                        @foreach($personaChannels as $index => $channel)
                            <div class="flex items-center gap-2">
                                ...
                                />
                                <button type="button" wire:click="removeChannel({{ $index }})" class="p-2 text-[color:var(--nx-faint)] hover:text-red-500 transition-colors flex-shrink-0">
                                    @svg('heroicon-o-x-mark', 'w-4 h-4')
                                </button>
                            </div>
                        @endforeach
            ...
            <div>
                <div class="flex items-center justify-between mb-4">
                    ...
                    <x-nx-button variant="ghost" size="sm" type="button" wire:click="addBrandLiked">
                        <div class="flex items-center gap-2">
                            @svg('heroicon-o-plus', 'w-4 h-4')
                            Hinzufügen
                        </div>
                        ...
                        @foreach($personaBrandsLiked as $index => $brand)
                            <div class="flex items-center gap-2">
                                <x-nx-input-text
                                    ...
                                    placeholder="Marke..."
                                />
                                <button type="button" wire:click="removeBrandLiked({{ $index }})" class="p-2 text-[color:var(--nx-faint)] hover:text-red-500 transition-colors flex-shrink-0">
                                    @svg('heroicon-o-x-mark', 'w-4 h-4')
                                </button>
                            </div>
                        @endforeach
            ...
            <div>
                ...
                <div class="p-4 bg-[color:var(--nx-hover)] rounded-[6px] border border-[color:var(--nx-line)]">
                    <label class="block text-sm font-medium text-[color:var(--nx-text)] mb-1.5">Welcher Ton für diese Persona?</label>
                    <select
                    ...
                    <p class="text-xs text-[color:var(--nx-faint)] mt-1.5">Ordne ein Tone of Voice Board zu, um den Kommunikationston für diese Zielgruppe festzulegen.</p>
                </div>
            </div>
        </div>
