        ...
        <x-ui-page-actionbar :breadcrumbs="[
            ...
            <x-slot name="left">
                @can('update', $toneOfVoiceBoard)
                    <x-ui-button variant="ghost" size="sm" x-data @click="$dispatch('open-modal-tone-of-voice-board-settings', { toneOfVoiceBoardId: {{ $toneOfVoiceBoard->id }} })">
            ...
            @can('update', $toneOfVoiceBoard)
                <x-ui-button variant="primary" size="sm" x-data @click="$dispatch('open-modal-tone-of-voice-entry', { toneOfVoiceBoardId: {{ $toneOfVoiceBoard->id }} })">
