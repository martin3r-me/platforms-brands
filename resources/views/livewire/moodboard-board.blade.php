        ...
        <x-ui-page-actionbar :breadcrumbs="[
            ...
            <x-slot name="left">
                @can('update', $moodboardBoard)
                    <x-ui-button variant="ghost" size="sm" x-data @click="$dispatch('open-modal-moodboard-board-settings', { moodboardBoardId: {{ $moodboardBoard->id }} })">
            ...
            @can('update', $moodboardBoard)
                <x-ui-button variant="primary" size="sm" x-data @click="$dispatch('open-modal-moodboard-image', { moodboardBoardId: {{ $moodboardBoard->id }} })">
